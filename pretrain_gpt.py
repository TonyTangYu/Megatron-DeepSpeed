...
from lapp.utils.get_gpt_flops import get_gpt_layer_flops
...
def model_profile(pre_process=True, post_process=True):
    ...
    layer_flops, total_flops, layer_flops_list = get_gpt_layer_flops(model, dummy_inputs)
    del model 
    del dummy_inputs
    return layer_flops, total_flops, layer_flops_list
...
def model_provider(pre_process=True, post_process=True):
    ...
    layer_flops, total_flops, layer_flops_list = model_profile()
    print("layer_flops is ", layer_flops_list)
